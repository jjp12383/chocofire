angular.module('chocofireApp')
  .controller('UserProfileCtrl', function ($scope, $cookies, $rootScope, $stateParams, $route, $modal, User, Chocolate, $localStorage, $firebaseObject, Ref, Auth, $location, $timeout) {
    ...
    user.$loaded().then(function () {
      ...
      chocolates.$loaded().then(function () {
        ...
        $scope.currentUser = User.getLocalUser();
