angular.module('chocofireApp')
  .directive('jsAngucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', function ($q, $parse, $http, $sce, $timeout, $templateCache) {
  // keyboard events
  var KEY_DW  = 40;
  var KEY_RT  = 39;
  var KEY_UP  = 38;
  ...
  $templateCache.put(TEMPLATE_URL,
    ...
    '      <div ng-if="!matchClass && result.description && result.description != \'\'" class="angucomplete-description"><span class="auto-complete-star star-{{result.description * 10}}"></span></div>' +
    '    </div>' +
    '  </div>' +
    '</div>'
  );
